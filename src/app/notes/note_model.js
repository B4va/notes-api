...
export default (noteInfo) => {
   ...
   */
	...
	const note = _validate(noteInfo, PRESETS);
	return _normalize(noteInfo, PRESETS);
   ...
   */
	function _validate({ title, content, color } = {}, PRESETS) {
		const errors = [];
   ...
   */
	function _normalize({ title, content, color }, PRESETS) {
		return {
			title: title,
			content: content,
