...
export const dataError = () =>
  _buildHttpError(400, 'Impossible de lire les données.');
...
export const invalidDataError = (e) =>
  _buildHttpError(400, 'Les données renseignées sont invalides.', e.details);
...
export const uniqueViolationError = (e) =>
  _buildHttpError(400, 'Les données renseignées sont invalides.', e.message);
...
export const authValidationError = () =>
  _buildHttpError(401, 'Accès non autorisé.');
...
export const noDataFoundError = () =>
  _buildHttpError(404, "Aucune donnée n'a été trouvée");
